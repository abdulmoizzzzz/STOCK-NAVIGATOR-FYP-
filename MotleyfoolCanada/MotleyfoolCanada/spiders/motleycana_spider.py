...
class MotleycanaSpiderSpider(scrapy.Spider):
    name = "motleycana_spider"
    allowed_domains = ["www.fool.ca"]
    start_urls = ["https://www.fool.ca/recent-headlines/"]
    ...
    def parse(self, response):
        ...
        for index, article in enumerate(news_articles):
            ...
            # Get the corresponding link for the current article
        ...
        # Extract next page URL and recursively call parse if next page exists
